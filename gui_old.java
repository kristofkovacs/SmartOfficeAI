...
class Gui{
	...
	private static final String windowTitle = "Intelligens Elosztott Rendszerek - 2018";
	private static final String roomControlPanelTitle = "Control Panel";
	...
	public Gui(){
		...
		panel = new JPanel();
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), roomControlPanelTitle, TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
	...
	public void emergencyCall(String operation){
		switch (operation){
			case "firefighters" : 
				txtStandBy.setText("Calling firefighters");
				break;
			case "police" : 
				txtStandBy.setText("Calling police");
				break;
			case "ambulance" : 
				txtStandBy.setText("Calling ambulance");
				break;
	...
	public void emergencyExits(String state){
		switch (state){
			case "open" : 
				txtClosed.setText("Forced open");
				break;
			case "close" : 
				txtClosed.setText("Forced close");
				break;
			case "manual" : 
			default : 
				txtClosed.setText("Manual operation");
	...
	public void emergencyGates(String state){
		switch (state){
			case "open" : 
				txtClosed_1.setText("Forced open");
				break;
			case "close" : 
				txtClosed_1.setText("Forced close");
				break;
			case "manual" : 
			default : 
				txtClosed_1.setText("Manual operation");
